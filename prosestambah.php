...
$result = mysqli_real_escape_string($conn, "INSERT INTO `produk` (`id`, `nama_barang`, `harga`, `gambar`, `ukuran`, `kategori`, `updated_at`) VALUES ('$id', '$nama_barang', '$harga', '$gambar', '$ukuran', '$kategori', '$updated_at');");
